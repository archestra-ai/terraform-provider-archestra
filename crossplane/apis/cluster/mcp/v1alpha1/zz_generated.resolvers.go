...
// ResolveReferences of this ServerInstallation.
func (mg *ServerInstallation) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
		...
		To: reference.To{
			List:    &RegistryCatalogItemList{},
			Managed: &RegistryCatalogItem{},
		},
	})
	if err != nil {
