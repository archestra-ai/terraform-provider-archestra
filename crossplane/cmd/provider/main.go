...
import (
	...
	apisCluster "github.com/archestra-ai/provider-archestra/apis/cluster"
	apisNamespaced "github.com/archestra-ai/provider-archestra/apis/namespaced"
	"github.com/archestra-ai/provider-archestra/config"
	"github.com/archestra-ai/provider-archestra/internal/clients"
	controllerCluster "github.com/archestra-ai/provider-archestra/internal/controller/cluster"
	controllerNamespaced "github.com/archestra-ai/provider-archestra/internal/controller/namespaced"
	"github.com/archestra-ai/provider-archestra/internal/features"
	"github.com/archestra-ai/provider-archestra/internal/version"
)
...
func main() {
	...
	log := logging.NewLogrLogger(zl.WithName("provider-archestra"))
	if *debug {
	...
	mgr, err := ctrl.NewManager(cfg, ctrl.Options{
		...
		LeaderElectionID: "crossplane-leader-election-provider-archestra",
		Cache: cache.Options{
