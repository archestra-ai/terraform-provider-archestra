...
func TestProviderResources_RegistrationCount(t *testing.T) {
	...
	expectedCount := 10 // agent, mcp_server, mcp_server_installation, team, team_external_group, tool_invocation_policy, trusted_data_policy, token_price, limit, optimization_rule
...
func TestProviderDataSources_RegistrationCount(t *testing.T) {
	...
	expectedCount := 5 // team, team_external_groups, agent_tool, mcp_server_tool, token_prices
