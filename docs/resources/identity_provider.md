...
page_title: "archestra_identity_provider Resource - archestra"
subcategory: ""
description: |-
  Manages Archestra identity providers (OIDC or SAML). Exactly one of oidc_config or saml_config must be set.
---

# archestra_identity_provider (Resource)
