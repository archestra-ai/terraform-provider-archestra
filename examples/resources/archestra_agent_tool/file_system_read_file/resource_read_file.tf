...
data "archestra_mcp_server_tool" "read_text_file" {
  mcp_server_id = "58df7d2c-413e-455d-b67b-ddb23c8c4ed5"
  name          = "modelcontextprotocol__servers__src__filesystem__read_file"
}
...
resource "archestra_profile_tool" "read_text_file" {
  ...
  credential_source_mcp_server_id = "58df7d2c-413e-455d-b67b-ddb23c8c4ed5"

  # Specify which MCP server executes the tool (defaults to the tool's MCP server)
  execution_source_mcp_server_id = "58df7d2c-413e-455d-b67b-ddb23c8c4ed5"
